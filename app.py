...
#         options = e.options
#         return f"Ambiguous term. Possible options: {', '.join(options)}"
...
#-----------------------------------------------------------------------------
# def getDiseaseInfo(keyword):
#     user_agent = "app/1.0 (vedangdeshmukh777@gmail.com)"
...
#     print(keywords)
#     print("-----------------------------")
#     results = DDGS(keywords)
#     print(results)
#     print("-----------------------------")

#     if results and results[0] and 'body' in results[0]:
#         return results[0]['body'], None

#     return "No information available for the given keywords.", None
